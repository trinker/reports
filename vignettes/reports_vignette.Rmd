...
2. Run <strong>`python -m SimpleHTTPServer`<\strong> in the command line     
3. Use <strong>`http://localhost:8000/THE_NAME OF_REVEALJS_PRESNETATION.html`<\strong> in the browser url bar    
