...
The user may then click on the bash/batch file generated by `r FUN("local_host")` and run the presetation locally. `r yt("http://youtu.be/sg_lKU3n-co")` (note that this file must be clicked on outside of RStudio).  This automatically creates a local host and opens the directory of the presentation for automatic access to locally hosted presentations.
...
<h4 id="odd2">Custom style.css With RStudio + knitr `r yt("http://youtu.be/HA3CXf3K194")`</h4>
