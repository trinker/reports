...
The following must be conducted  each time you want show a presentation locally. `r yt("http://youtu.be/6VRMcHyXEKc")`     
...
<h4 id="odd2">Custom style.css With RStudio + knitr `r yt("http://youtu.be/YESvfZLCVoI")`</h4>
