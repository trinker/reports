...
Note that the path to a style.css can be supplied to `r FUN("custom_css")`.  This may be a user defined file or an internal file from the reports style.css library (see `r FUN("css_styles", "custom_css")`).  For examples see: https://github.com/trinker/style.css_examples.  Feel free to submit your own style.css to the reports package <a href="mailto:reports.rpackage@gmail.com" target="_blank">reports.rpackage@gmail.com</a> marked with <b>style.css</b> template in the subject line.
