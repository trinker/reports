...
#' @param slidify_clean logical.  If TRUE the PRESENTATION .Rmd file will be 
#' generated by slidify.  If FALSE the .Rmd file will be initialize with 
