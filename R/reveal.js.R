# Convert md to HTML5 reveal.js  (work in progress)
# 
...
function(in.file = NULL, out.file = NULL, ref.page = "References", 
    ...
    action <- paste0(wheresPandoc(),"  -t html5 --template=template-revealjs.html ",
        "  --standalone --section-divs ", " --variable theme=\"beige\" ",
        " --variable transition=\"linear\" ", in.file, " -o ", out.file)
